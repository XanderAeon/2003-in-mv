//the utils script, this script is used for a bunch of random shit including the crash handler for some reason.
...
#macro nu var weedweedweed = new 
//#macro shader_reset() shader_set(z_normal)
